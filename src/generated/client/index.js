...
exports.Prisma.UserScalarFieldEnum = {
  ...
  twoFactorAuthenticatorEnabled: 'twoFactorAuthenticatorEnabled',
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\husey\\PROJE\\spacecraft-3d\\src\\generated\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\husey\\PROJE\\spacecraft-3d\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "datasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../src/generated/client\"\n}\n\nmodel Account {\n  id                String  @id @default(cuid())\n  userId            String\n  type              String\n  provider          String\n  providerAccountId String\n  refresh_token     String?\n  access_token      String?\n  expires_at        Int?\n  token_type        String?\n  scope             String?\n  id_token          String?\n  session_state     String?\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@unique([provider, providerAccountId])\n}\n\nmodel Session {\n  id           String   @id @default(cuid())\n  sessionToken String   @unique\n  userId       String\n  expires      DateTime\n  user         User     @relation(fields: [userId], references: [id], onDelete: Cascade)\n}\n\nmodel User {\n  id                            String    @id @default(cuid())\n  name                          String?\n  email                         String?   @unique\n  emailVerified                 DateTime?\n  image                         String?\n  password                      String?\n  twoFactorEnabled              Boolean   @default(false)\n  twoFactorEmailEnabled         Boolean   @default(false)\n  twoFactorSmsEnabled           Boolean   @default(false)\n  twoFactorAuthenticatorEnabled Boolean   @default(false)\n  twoFactorMethod               String    @default(\"EMAIL\")\n  twoFactorSecret               String?\n  twoFactorPhone                String?\n  twoFactorCode                 String?\n  twoFactorExpires              DateTime?\n\n  // Abunəlik məlumatları (Stripe)\n  stripeCustomerId     String? @unique\n  stripeSubscriptionId String? @unique\n  subscriptionStatus   String? @default(\"STARTER\") // STARTER, PRO, ENTERPRISE\n\n  accounts Account[]\n  sessions Session[]\n  projects Project[]\n}\n\nmodel VerificationToken {\n  identifier String\n  token      String   @unique\n  expires    DateTime\n\n  @@unique([identifier, token])\n}\n\nmodel Project {\n  id         String   @id @default(cuid())\n  name       String\n  userId     String\n  data       String // JSON formatında furnitureLayers yadda saxlanılacaq\n  wallColor  String   @default(\"#ffffff\")\n  floorColor String   @default(\"#8c8c8c\")\n  createdAt  DateTime @default(now())\n  updatedAt  DateTime @updatedAt\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n}\n",
  "inlineSchemaHash": "8b7efeeda4bf9027fb0c046fc8fd8c3adc7b0561e2e67664ccd63ab9e5eb8631",
  "copyEngine": true
}
