...
export default function PropertiesPanel() {
  ...
  const rawSelectedItem = furnitureLayers.find((f) => f.id === selectedId);
  const selectedItem = (rawSelectedItem?.type === "room" || rawSelectedItem?.name?.includes("Otaq Kubu") || rawSelectedItem?.name === "Otaq Bloku") ? null : rawSelectedItem;
